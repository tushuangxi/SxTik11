...
public class BigFloatErWeiMaView extends RelativeLayout {
    ...
    private ImageView iv_creat_erweima;
    ...
    public BigFloatErWeiMaView(Context context, WindowManager.LayoutParams wmParams, WindowManager winManager) {
        super(context);
        this.context = context;
        this.wmParams = wmParams;
        this.winManager = winManager;
        mFloatingLayout = View.inflate(context, R.layout.big_remoteview, this);
