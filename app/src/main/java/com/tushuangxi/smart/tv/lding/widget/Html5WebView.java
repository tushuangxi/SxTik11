...
import com.tushuangxi.smart.tv.lding.utils.NetStatusUtil;
...
//        saveData(mWebSettings);
    ...
    private void saveData(WebSettings mWebSettings) {
        ...
        if (NetStatusUtil.isConnected(LoadingApp.getContext())) {
        ...
        File cacheDir = LoadingApp.getContext().getCacheDir();
        if (cacheDir != null) {
