...
public class DateFormatUtils {
     ...
     * @return
     */
    public static String long2ByStr(long timestamp, boolean isPreciseTime) {
        return long2Str(timestamp, getFormatPatternBy(isPreciseTime));
    }
    ...
    //年月  ------- 年月日
    private static String getFormatPatternBy(boolean showSpecificTime) {
        if (showSpecificTime) {
            return DATE_FORMAT_PATTERN_YMD_HM;
        } else {
