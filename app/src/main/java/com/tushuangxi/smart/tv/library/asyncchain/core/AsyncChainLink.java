package com.tushuangxi.smart.tv.library.asyncchain.core;
...
public class AsyncChainLink implements AsyncChainLifeCycleListener {
    ...
    /**
     * 开始执行
     * 1.获取一个{@link // com.bearever.async.chain.lifecycler.base.AsyncChainLifeCycle}实例
     * 2.{@link  //com.bearever.async.chain.lifecycler.base.AsyncChainLifeCycle}实例添加当前{@link AsyncChainLink}
     * 3.{@link AsyncChainManager}添加{@link //com.bearever.async.chain.lifecycler.base.AsyncChainLifeCycle}实例
     */
